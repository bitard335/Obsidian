...
[](https://learn.javascript.ru/cookie# "выполнить")

[](https://learn.javascript.ru/cookie# "открыть в песочнице")
...
## [samesite](https://learn.javascript.ru/cookie#samesite)
...
### [Атака XSRF](https://learn.javascript.ru/cookie#ataka-xsrf)
...
### [Настройка samesite](https://learn.javascript.ru/cookie#nastroyka-samesite)
...
## [Приложение: Функции для работы с куки](https://learn.javascript.ru/cookie#prilozhenie-funktsii-dlya-raboty-s-kuki)
...
### [getCookie(name)](https://learn.javascript.ru/cookie#getcookie-name)
...
### [setCookie(name, value, options)](https://learn.javascript.ru/cookie#setcookie-name-value-options)
...
### [deleteCookie(name)](https://learn.javascript.ru/cookie#deletecookie-name)
...
## [Приложение: Сторонние куки](https://learn.javascript.ru/cookie#prilozhenie-storonnie-kuki)
...
## [Приложение: GDPR](https://learn.javascript.ru/cookie#prilozhenie-gdpr)
...
## [Итого](https://learn.javascript.ru/cookie#itogo)
