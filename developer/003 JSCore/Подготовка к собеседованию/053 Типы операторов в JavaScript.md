...
___
#JS #операторПрисваивания #операторСравнения #арифметическийОператор #битовыйОператор #строковыйОператор #тернарныйОператор #операторЗапятая #унарныйОператор #операторыОтношения #операторНулевогоСлияния
